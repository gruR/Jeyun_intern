package com.example.jeyun_worker.indooratlas.Simple;
...
public class SimpleActivity extends FragmentActivity {
    ...
    private IARegion.Listener mRegionListener = new IARegion.Listener() {
        ...
        public void onEnterRegion(IARegion region) {
            if (region.getType() == IARegion.TYPE_FLOOR_PLAN) {
                ...
                Toast.makeText(SimpleActivity.this, id, Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ExampleUtils.shareTraceId(findViewById(R.id.imageView), SimpleActivity.this,
                mIALocationManager);
